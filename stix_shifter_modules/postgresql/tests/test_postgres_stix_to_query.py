...
FROM_STIX_MAPPING_FILE_2_0 = open('stix_shifter_modules/postgresql/stix_translation/json/from_stix_map.json').read()
FROM_STIX_MAPPINGS_2_0 = json.loads(FROM_STIX_MAPPING_FILE_2_0)
FROM_STIX_MAPPING_FILE_2_1 = open('stix_shifter_modules/postgresql/stix_translation/json/stix_2_1/from_stix_map.json').read()
...
def _translate_query(stix_pattern, options={}):
    return translation.translate('postgresql', 'query', '{}', stix_pattern, options)
